...
<table width="776" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  onsubmit="return validarFieldCadProd(this)" action="cadastrar_produtos.jsp?acao=1">
          ...
          <td valign="top"><fieldset>
            ...
            <table width="500" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                ...
                <input name="id_proCadastro" id="id_proCadastro" type="text" id="id" size="10" readonly="true"
