...
<html>
    <head>
        ...
        <title>::BUSCA DE PRODUTO ENTRADA::</title>
...
<table width="776" border="0" align="center" cellpadding="0" cellspacing="0" >
  ...
  <tr>
    ...
    <legend class="formato_label"> Busca Produto para Entrada: </legend>
    <legend class="formato_label"></legend>
      <form id="form1" name="formBusca" method="post" action="busca_produto_entrada.jsp?acao=1">
        ...
        <table width="579" border="0" align="center" cellpadding="0" cellspacing="0">
          ...
          <tr>
            ...
            <td align="center" ><a href="cadastrar_produtos_entrada.jsp"><font size="5" color="#000000">NOVO PRODUTO</font></a></td>
            <td>&nbsp;</td>
          </tr>
          <tr>
            <td>&nbsp;</td>
...
%>
                        <tr>
                            ...
                            <td width="204"  align="right" class="formato_label"><%=String.format("%03d",listar.getQuantidade())%></td>
                           ...
                           href="entrada_produtos.jsp?id_produto=<%=listar.getIdProduto()%>&nome_prodLoc=<%=listar.getNome()%>">
